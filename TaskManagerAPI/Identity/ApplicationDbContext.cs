...
namespace TaskManagerAPI.Identity
{
    public class ApplicationDbContext:IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Project() { ProjectID = 1, ProjectName = "Hospital Management System", DateOfStart = "2017-8-1", Active = true, ClientLocationID = 2, Status = "In Force", TeamSize = 14 },
            new Project() { ProjectID = 2, ProjectName = "Reporting Tool", DateOfStart = "2018-3-16", Active = true, ClientLocationID = 1, Status = "Support", TeamSize = 81 }
            );
